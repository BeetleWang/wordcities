...
population_filter = st.slider('Minimal Median House Price (Millions):', 0, 50001, 20000)  # min, max, default
...
fig,ax=plt.subplots(figs1ze=(20,20))
ax.hist(filtered_df['median house value'],bins=30)

#Set title,labels,and yaxis limits
ax.set_title('Histogram of Median House Value',fontsize=16)
ax.set_xlabel('Median House Value',fontsize=12)
ax.set_ylabel('Frequency',fontsize=12)

#Display the histogarm
st.pyplot(fig)